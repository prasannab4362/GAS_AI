...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-brand-black">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-brand-gray/50 via-brand-black to-brand-black z-0" />
      <ParticleCanvas />
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neon-green/10 border border-neon-green/20 text-neon-green mb-8"
        >
        ...
        >
          ...
          <Link href="/contact" className={cn(buttonVariants({ variant: "outline", size: "lg" }), "w-full sm:w-auto border-white/20 hover:bg-white/5 text-white")}>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-32 bg-neon-green/10 blur-[100px] z-0 rounded-full" />
    </section>
  );
}
