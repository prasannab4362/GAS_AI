    ...
    <section className="py-24 bg-brand-gray relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          >
            <Link href="/projects" className={cn(buttonVariants({ variant: "outline" }), "border-white/20 text-white hover:bg-white/5")}>
          ...
          {PROJECTS.map((project, i) => (
            ...
            >
              ...
              <div className="p-6 relative z-20 bg-brand-gray/90 backdrop-blur-sm border-t border-white/5">
                ...
                <Link href="/projects" className="inline-flex items-center text-sm font-medium text-brand-cyan hover:text-neon-green transition-colors">
